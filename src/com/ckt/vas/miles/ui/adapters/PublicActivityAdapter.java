        ...
        if (convertView == null || (holder = (ViewHolder) convertView.getTag()).flag != position) {
            ...
            if (position == 0) {
                ...
                if (ActivityMessage.MESSAGE_TYPE_TEXT == type) {
                    ...
                    View view = LayoutInflater.from(context).inflate(R.layout.moment_thought_partial, null);
                ...
                // Friend
                    ...
                    smal.setVisibility(View.GONE);
                    big.setVisibility(View.VISIBLE);
                    View view = LayoutInflater.from(context).inflate(R.layout.moment_people_partial, null);
